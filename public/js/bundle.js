...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoic2lnbmlvcmdyYXRpYW5vIiwiYSI6ImNrM2ppMWEwaTBqYzEzZWtvNzRzOWV6ZzAifQ.dSBe3phJn80pGvAOjBRU_w';
      ...
      switch (_context.prev = _context.next) {
        case 0:
          ...
          return regeneratorRuntime.awrap((0, _axios.default)({
            method: 'POST',
            url: 'http://127.0.0.01:3000/api/v1/users/login',
            data: {
              email: email,
              password: password
            }
    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          ...
          return regeneratorRuntime.awrap((0, _axios.default)({
            method: 'GET',
            url: 'http://127.0.0.01:3000/api/v1/users/logout'
          }));
...
/* eslint-disable */
var stripe = Stripe('pk_test_WVpLcRsuhgdNZDOCkLahPccl00KdwwKRAq');
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return regeneratorRuntime.awrap((0, _axios.default)("http://127.0.0.01:3000/api/v1/bookings/checkout-session/".concat(tourId)));
